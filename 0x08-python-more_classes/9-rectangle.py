...
class Rectangle:
    ...
    Attributes:
        ...
        print_symbol (any): string representation using symbol
    """
    ...
    @property
    def width(self):
        """Getting/setting width of Rectangle"""
        return self.__width
    ...
    @property
    def height(self):
        """Getting/setting height of Rectangle"""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Returning Rectangle with greater area

        Args:
            rect_1 (Rectangle): First Rectangle,
            rect_2 (Rectangle): Second Rectangle,
        Raises:
            TypeError: In case either of rect_1 or rect_2 is !Rectangle.
        """
